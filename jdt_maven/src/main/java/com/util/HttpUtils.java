...
public class HttpUtils {
    ...
    public static String postRequestSendJSON(String url,Map<String,String> headers ,String param){
        String result = null;
        CloseableHttpClient httpClient = buildHttpClient();
        HttpPost httpPost = new HttpPost(url);
        ...
        httpPost.setEntity(new StringEntity(param,defaultEncoding));
        try {
            CloseableHttpResponse response = httpClient.execute(httpPost);
            try {
                HttpEntity entity = response.getEntity();
    ...
    public static Map<String,String> getHeader(){
        ...
        byte[] encode = Base64.encode("admin@raising:rms56807268".getBytes());
        String authStringEnc = new String(encode);
