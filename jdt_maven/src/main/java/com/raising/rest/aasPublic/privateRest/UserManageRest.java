...
@Component
@Path("/raising")
public class UserManageRest extends BaseController {
     ...
     */
    @POST
    @Path("/userManagementRest/getRows.do")
    ...
    public JSONObject getRows(String ajaxParam){
        ...
        try{
            ...
            for(int i=0;i<groupMemeber.size();i++){
                ...
                if(!userIds.contains(tempId) && (userId != tempId)){
    ...
    @GET
    @Path("/userManagementRest/getProgenyGroup.do")
    @Produces(MediaType.APPLICATION_JSON)
    public JSONObject getProgenyGroup(@QueryParam("ajaxParam") String ajaxParam){
        JSONObject returnInfo = new JSONObject();
        try{
            MultipleDataSource.setDataSourceKey(CSVUtils.ConstantsUtil.AASCCS_DATA_SOURCE);
    ...
    @POST
    @Path("/userManagementRest/insert.do")
    @Produces(MediaType.APPLICATION_JSON)
    public JSONObject insert(String ajaxParam) {
        ...
        try{
            ...
            returnInfo = backstageUserService.addRow(data,token);
            ...
            returnInfo = roleUserService.bindUser(groupUserParam.toJSONString(),userId);
    ...
    @POST
    @Path("/userManagementRest/update.do")
    @Produces(MediaType.APPLICATION_JSON)
    ...
    @POST
    @Path("/userManagementRest/delete.do")
    @Produces(MediaType.APPLICATION_JSON)
     ...
     */
    @POST
    @Path("/userManagementRest/setValidity.do")
    @Produces(MediaType.APPLICATION_JSON)
     ...
     */
    @POST
    @Path("/userManagementRest/abandonValidity.do")
    @Produces(MediaType.APPLICATION_JSON)
     ...
     */
    @POST
    @Path("/userManagementRest/keepValidity.do")
    @Produces(MediaType.APPLICATION_JSON)
