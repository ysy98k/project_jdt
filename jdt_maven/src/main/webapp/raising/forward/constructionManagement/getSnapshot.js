        ...
        if(request.status == 200){
            ...
            if (Number(data.errcode) == 0) {
                ...
                for (var i = 0; i < recordsArr.length; i++) {
                    var temp = {};
                    temp.instanceId = recordsArr[i].instance_id;
                    temp.value = recordsArr[i].property_values[0].value;
                    showData.dataArr.push(temp);
                    showData.time = getMyDate(recordsArr[i].property_values[0].timestamp);
                }
            }
