...
<div id="father" class="page-content" style="position:inherit;min-height:600px">
    ...
    <div class="page-header" id="header">
        ...
        <div style="float: right;margin-top: -20px;margin-right: 15px;">
            <a href="javascript:insertPage()" style="cursor:pointer;"><span id = "currentTbm"></span></a>
        </div>
    </div>
    <!-- 内容-->
    <div class="row" >
                ...
                <div class="widget-header tableTile">
                    <div>
                        <span class="widget-title lighter smaller" id="sTitle">
                            ...
                            <a href="javascript:void(0)" id="uploadButton" onclick="dataUpload()">文件上传</a>
                        </span>
                ...
                <div class="widget-main no-padding">
                    <table class="table table-striped table-bordered table-hover" style="table-layout:fixed;">
                        ...
                        <tr v-for="(row,index) in rows" class="dataTable" >
                            ...
                            <td align="center" onclick="previewFile(this)" value="预览" v-bind:data-fileName="row.fileName" style="cursor:pointer;">{{row.fileName}}</td>
...
<script type="text/javascript" src="<%=toolkitPath%>/raising/forward/tbmManage/factory.js"></script>
</body>
</html>
