...
<script type="text/javascript" src="<%=toolkitPath%>/raising/forward/materialConsumption/materialConsumption.js"></script>
<input type="hidden" value="<%=tenantid%>" id="tenantid">
<div class="page-content" style="min-height:600px;min-width: 1600px;">
    ...
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-8  searchArea" id="queryarea">
            ...
            <div class="row" >
                <div class="col-xs-12 col-sm-6 col-md-7  no-padding">
                    <div class="col-xs-12 col-sm-2 col-md-2 dada">
                        <select id="inqu_status-materialType" data-bxwidget class="inputThree lala">
                            <option value="GTotal">注浆</option>
                            <option value="Etotal">膨润土</option>
                            <option value="FOTotal">泡沫</option>
                        </select>
                    </div>
                    <div class="col-xs-12 col-sm-2 col-md-2 dada">
                        <select id="inqu_status-timeType" data-bxwidget class="inputThree lala">
                            <option selected value="ring">环</option>
                            <option value="day">日</option>
                            <option value="month">月</option>
                            <option value="season">季</option>
                        </select>
                    </div>
                    <div id="timeCondition" class="col-xs-12 col-sm-7 col-md-7" style="display: none;">
                        <label class="labelThree" style="margin:0px 10px 0px 30px;" for="inqu_status-startTime">日期</label>
                        <input type="text" id="inqu_status-startTime" data-bxwidget class="inputThree" style="max-width: 100px;"/>
                        <label class="labelThree di"  >至</label>
                        <input type="text" id="inqu_status-endTime" data-bxwidget class="inputThree" style="max-width: 100px;"/>
                    </div>
                    <div id="ringCondition" class="col-xs-12 col-sm-7 col-md-7">
                        <label class="labelThree" style="margin:0px 10px 0px 30px;" for="inqu_status-startTime">环号</label>
                        <input type="text" id="inqu_status-startRingNum" data-bxwidget class="inputThree" style="max-width: 100px;"/>
                        <label class="labelThree di"  >至</label>
                        <input type="text" id="inqu_status-endRingNum" data-bxwidget class="inputThree" style="max-width: 100px;"/>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6 col-md-3 no-padding">
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6  no-padding-right-1024">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 four">
                <div id="jqGrid4"></div>
            </div>
        </div>
        ...
        <div class="col-xs-12 col-md-4 two" style="display: none;">
            <div id="myCharts2" style="min-width: 500px;height:550px;"></div>
        </div>
        <div class="col-xs-12 col-md-4 three" style="display: none;">
            <div id="myCharts3" style="min-width: 500px;height:550px;"></div>
        </div>
        <div class="col-xs-12 col-md-4 four" style="display: none;">
            <div id="myCharts4" style="min-width: 500px;height:550px;"></div>
        </div>
        <!-- /.col -->
    </div>
