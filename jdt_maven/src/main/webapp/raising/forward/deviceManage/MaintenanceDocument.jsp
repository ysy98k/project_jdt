...
<script type="text/javascript" src="<%=toolkitPath%>/raising/forward/deviceManage/MaintenanceDocument.js"></script>
...
<div id="father" class="page-content" style="position:inherit;min-height:600px">
    ...
    <!-- 内容-->
    <div class="row" >
        <div class="col-xs-12 col-sm-1 col-md-1  no-padding"></div>
        <div class="col-xs-12 col-sm-8 col-md-8  no-padding">
            <input type="hidden" name="ctl00$MainBodyContent$hidTypeId1" id="hidTypeId1" value="0">
            <table class="table table-condensed no-border">
                <tbody>
                    <tr id="trSimpleArea">
                        <td style="width: 220px; vertical-align: middle;border: 0px;">
                            <div class="input-group input-group-sm" style="width: 300px">
                                <div class="input-group-addon">选择归档类型(父节点)</div>
                                <select name="ctl00$MainBodyContent$ddlAllArchiveType" onchange="javascript:setTimeout('__doPostBack(\'ctl00$MainBodyContent$ddlAllArchiveType\',\'\')', 0)" id="ddlAllArchiveType" class="form-control select2">
                        ...
                        <td style="width: 220px; vertical-align: middle;border: 0px;">
                            <div class="input-group input-group-sm" style="width: 300px">
                                <div class="input-group-addon">选择归档类型(子节点)</div>
                                <select name="ctl00$MainBodyContent$ddlArchiveType" onchange="javascript:setTimeout('__doPostBack(\'ctl00$MainBodyContent$ddlArchiveType\',\'\')', 0)" id="ddlArchiveType" class="form-control select2">
    ...
    <div class="row" style="margin: 0px;">
        <div class="col-xs-12 no-padding">
            <div style="display: inline-block;">
                <button class="btn btn-primary" onclick="makeGraph()">新增附件归档</button>
            </div>
        </div>
    </div>
    <div class="row">
