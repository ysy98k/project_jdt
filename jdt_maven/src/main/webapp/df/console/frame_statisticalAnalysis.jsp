...
<script type="text/javascript">
    ...
    AjaxCommunicator.ajaxRequest(
        '/raising/forward/statisticalAnalysis/jumpPage.do',
        'POST', {}, callback);
</script>
...
<div class="main-container" id="main-container">
    ...
    <div id="sidebar" class="sidebar responsive">
        ...
        <script type="text/javascript">
            ...
            param = {"menuType": "statisticalAnalysisMenu", "fieldName": "menuOrder", "ascDesc": "asc"};
            var callbackMenu = {
                onSuccess: function (paramJsonObj) {
                    ...
                    if (menus[i].parentCode == '0') {//1级菜单
                        ...
                        if (menus[i].subMenus != null) {
                            ...
                            if (menus[i].linkType == 'leafNode') {
                                var firstLevel = encodeURIComponent(encodeURIComponent(menus[i].parentName));
                                var secondLevel = encodeURIComponent(encodeURIComponent(menus[i].dispName));
                                var subLink = "onClick='readyToOpenForm(" + '\"' + menus[i].pagePath +"?firstLevel="+firstLevel+"&secondLevel="+secondLevel+ '\"' + ',\"' + menus[i].linkParam + '\"' + ',\"' + menus[i].parentCode +"\")'";
                            }
                        }
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                ...
                //左菜单是否收缩
                if (!$("#sidebar").hasClass("menu-min")) {// !的有无，决定左侧菜单是否默认收缩。加!表示默认收缩
                    hasMenuMin();
                } else {
