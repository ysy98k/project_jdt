...
<script type="text/javascript"
        src="<%=path%>/bxui/jquery/dist/jquery-migrate-1.1.0.js"></script>
<script type="text/javascript">
    //获取框架配置
    var frame_pagePath;
    var frame_pageType;
    ...
    AjaxCommunicator.ajaxRequest(
        '/df/metamanage/frameSetting.do?method=queryFrame',
        'POST', {}, callback);
</script>
<link rel="stylesheet" href="<%=path%>/df/console/css/style-frame.css" />
<div class="noNavber"></div>
<div id="navbar" class="navbar navbar-default" mouseOver="" mouseOut="">
    <script type="text/javascript">
    ...
    <div class="navbar-container" id="navbar-container">
        ...
        <div class="pull-left logoDiv navButtonText">
            <a class="navbar-brand" style="cursor: pointer" title="回到首页"  onClick="readyToOpenForm('<%=path%>/df/console/frameTop.do','self');">
                <small><img id="logoIcon" src="" style="max-height: 25px"></small>
            </a>
        </div>

        <div class="pull-left"><a style="cursor: pointer" title="回到首页"  onClick="readyToOpenForm('<%=path%>/df/console/frameTop.do','self');">
            <span class="navButtonText" id="logoText"></span></a>
        </div>
        <div class="pull-right upButton" role="navigation">
            <ul class="nav ace-nav">
                <li style="width: 20px;background-color: #5a5959">
                    <a data-toggle="dropdown" onclick="hideNavbar();" href="#" class="dropdown-toggle" >
                        <i class="ace-icon fa fa-chevron-up" style="margin-left: -24px;"></i>
                    </a>
                </li>
            </ul>
        </div>
...
<div class="main-container" id="main-container">
    ...
    <div id="sidebar" class="sidebar responsive">
        ...
        <ul  class="nav nav-list">
            <li class="">
                <a id="home" href="" onClick="readyToOpenForm('<%=path%>/df/console/frameTop.do','self');" class="dropdown-toggle selHome"  style="height: 45px">
                    <i class="menu-icon"><img src="<%=path%>/df/console/images/home.png" /></i>
                    <span class="menu-text"><b>xInsight应用开发平台</b></span>
                </a>
                <b class="arrow"></b>
            </li>
        </ul>
        <ul  class="nav nav-list remoteAutoComplete">
            <li>
                <i class="fa fa-search" aria-hidden="true"></i>
                <input type="text" name="input"  id="autoComplete" placeholder="输入菜单名">
            </li>
        </ul>
        ...
        <script type="text/javascript">
            ...
            param={"menuType":"leftMenu","fieldName":"menuOrder","ascDesc":"asc"};
            var callbackMenu = {
                onSuccess : function(paramJsonObj) {
            ...
            function genMenu(menus){
                ...
                for(var i=0;i<menus.length;i++){
                    ...
                    if(menus[i].parentCode=='0'){//1级菜单
                        var submenuDiv="";
                        if(menus[i].subMenus!=null && menus[i].subMenus!=undefined){
                            ...
                            var menuDiv="<li class='nav-list-title'>"+
                                "<a class='dropdown-toggle' "+subLink+"><i class='menu-icon fa "+iconPath+"'></i>"+
                                "<span class='menu-text'>"+menus[i].dispName+"</span></a></li>";
                        }
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function(){
                if(frame_pagePath!=undefined && frame_pagePath!="")
                    readyToOpenForm(frame_pagePath,"embed");
                else{
                    var last_gritter;
                ...
                if($("#sidebar").hasClass("menu-min")){
                    ...
                    $(".main-content").css("padding-top","45px");
                    $(".upButton").css("display","none");
                }

                $("a").bind('dragstart', function(evt){return false;})//所有链接拖动时不现实详细url信息
    ...
    <!-- /section:basics/sidebar -->
    <div class="main-content" style="-webkit-overflow-scrolling:touch;overflow:auto;padding-top:45px;">
