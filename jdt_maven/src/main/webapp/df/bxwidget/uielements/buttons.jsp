				...
				<div class="page-content">
					...
					<div class="row">
						<div class="col-xs-12">
							...
							<div class="row">
								<div class="col-xs-12">
									<h3 class="header smaller lighter green">应用按钮</h3>
									<h3 class="header smaller lighter green">应用按钮</h3>

									<!-- #sectionController:elements.button.app -->
									<p>
										<a href="javascript:void(0);" class="btn btn-default btn-app radius-4">
											<i class="ace-icon fa fa-cog bigger-230"></i>
											Default
											<span class="badge badge-pink">+3</span>
										</a>

										<a href="javascript:void(0);" class="btn btn-app btn-primary no-radius">
											<i class="ace-icon fa fa-pencil-square-o bigger-230"></i>
											Edit
											<span class="badge badge-warning badge-left">11</span>
										</a>

										<a href="javascript:void(0);" class="btn btn-app btn-success">
										...
										<a href="javascript:void(0);" class="btn btn-app btn-info btn-sm no-radius">
										...
										<a href="javascript:void(0);" class="btn btn-app btn-yellow btn-xs">
							...
							<div class="row">
								<div class="col-sm-6" id="default-buttons">
									<h3 class="row header smaller lighter purple">
										<span class="col-sm-6"> 按钮颜色 </span><!-- /.col -->

										<span class="col-sm-6">
											<label class="pull-right inline" style="margin-bottom:0px">
												<small class="muted smaller-90">内边框效果：</small>
									...
									<!-- #sectionController:elements.button -->
									<p>
									...
									<!-- #sectionController:elements.button.white -->
									<p>
								...
								<div class="col-sm-6">
									<h3 class="header smaller lighter red">按钮大小</h3>
							...
							<div class="row">
								<div class="col-sm-6">
									<h3 class="header smaller lighter green">图标按钮</h3>
								...
								<div class="col-sm-6">
									<h3 class="header smaller lighter grey">禁用按钮</h3>
							...
							<div class="row">
								<div class="col-sm-6">
									<h3 class="header smaller lighter blue">按钮组</h3>
									...
									<div>
										...
										<!-- #sectionController:elements.button.group -->
								...
								<div class="col-sm-6">
									<h3 class="header smaller lighter green">下拉按钮</h3>
							...
							<div class="row">
								<div class="col-sm-6">
									<h3 class="header smaller lighter green">标签和徽章</h3>

									<!-- #sectionController:elements.label -->
									<p>
									...
									<!-- #sectionController:elements.badge -->
									<p>
								...
								<div class="col-sm-6">
									<h3 class="header smaller lighter red">分页按钮</h3>
